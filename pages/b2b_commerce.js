                                                            ...
                                                            <div class="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                                                                <a class="group">
                                                                    ...
                                                                    <div class="mt-6">
                                                                      ...
                                                                      <PayLater product="Earthen Bottle" amount={48}/>
                                                                    </div>
                                                                </a>
                                                                ...
                                                                <a class="group">
                                                                    ...
                                                                    <p class="mt-1 text-lg font-medium text-blue-900">ⓢ 89</p>        <div class="mt-6">
...
export default B2BCommercePage