    ...
    return (
        <main>
                ...
                <div class="mt-2 relative rounded-md shadow-sm">
                    <input type="text" name="did" id="did" class="focus:ring-blue-500 focus:border-blue-500 block w-full pr-10 sm:text-sm border-gray-300 rounded-md" placeholder="did:stateset:inv:..." onChange={handleOnChange} value={inputs.name} />
                </div>
            </div>
            <div>
