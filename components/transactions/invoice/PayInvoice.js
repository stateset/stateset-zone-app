...
const MsgPayInvoice = new Type("MsgPayInvoice")
...
export default (props) => {
    ...
    const handleOnSubmit = async() => {
        ...
        myRegistry.register("/stateset.core.invoice.MsgPayInvoice", MsgPayInvoice);
        ...
        if (client) {
            ...
            const message = {
                typeUrl: "/stateset.core.invoice.MsgPayInvoice",
                value: {
