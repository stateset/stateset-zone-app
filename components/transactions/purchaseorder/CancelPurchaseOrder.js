...
const MsgCancelPurchaseorder = new Type("MsgCancelPurchaseorder")
...
export default (props) => {
    ...
    const handleOnSubmit = async() => {
        ...
        if (client) {
            ...
            const message = {
                typeUrl: "/stateset.core.purchaseorder.MsgCancelPurchaseorder",
                value: {
            ...
            const response = await client.signAndBroadcast(creator_address, [message], "auto", 'canceling a purchase order from stateset zone');
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 w-0 flex-1 pt-0.5">
                                            ...
                                            <p class="mt-1 text-xs text-gray-500">
                                                Purchase Order Cancelled. Anyone with a link can now view this transaction.
                                            </p>
                                        </div>
