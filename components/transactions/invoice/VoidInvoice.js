...
const MsgVoidInvoice = new Type("MsgVoidInvoice")
...
export default (props) => {
    ...
    const handleOnSubmit = async() => {
        ...
        myRegistry.register("/stateset.core.invoice.MsgVoidInvoice", MsgVoidInvoice);
        ...
        if (client) {
            ...
            const message = {
                typeUrl: "/stateset.core.invoice.MsgVoidInvoice",
                value: {
            ...
            const response = await client.signAndBroadcast(creator_address, [message], "auto", 'paying a invoice from stateset zone');
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 w-0 flex-1 pt-0.5">
                                            ...
                                            <p class="mt-1 text-xs text-gray-500">
                                                Invoice Voided. Anyone with a link can now view this transaction.
                                            </p>
                                        </div>
