                                            ...
                                            <div className="-mx-4 mt-10 ring-1 ring-gray-300 sm:-mx-6 md:mx-0 md:rounded">
                                                <table className="min-w-full divide-y divide-gray-300">
                                                    ...
                                                    <tbody className="dark:text-white dark:bg-slate-900 bg-white divide-y divide-gray-200">
                                                        {loans.map((loan) => (
                                                            <tr key={loan.id}>
                                                                <td class="px-3 py-3.5 text-sm text-gray-500 lg:table-cell"><p class="dark:text-white text-gray-900 whitespace-no-wrap">ⓢ {loan.amount}</p></td>
                                                                <td class="px-3 py-3.5 text-sm text-gray-500 lg:table-cell"><p class="dark:text-slate-900 px-2 mt-1 truncate inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">{loan.state}</p></td>
                                                                <td class="px-3 py-3.5 text-sm text-gray-500 lg:table-cell"><p class="dark:text-white text-gray-900 whitespace-no-wrap">{loan.deadline}</p></td>
                                                                <td class="px-3 py-3.5 text-sm text-gray-500 lg:table-cell"><p class="dark:text-white px-3 py-3.5 text-sm text-gray-500 w-32 whitespace-no-wrap truncate overflow-hidden text-overflow: ellipsis">{loan.borrower}</p></td>
                                                                <td class="px-3 py-3.5 text-sm text-gray-500 lg:table-cell"><p class="dark:text-white px-3 py-3.5 text-sm text-gray-500 w-32 whitespace-no-wrap truncate overflow-hidden text-overflow: ellipsis">{loan.lender}</p></td>
