...
export default (props) => {
    ...
    return (
        <main>
                                ...
                                <div class="p-4">
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 w-0 flex-1 pt-0.5">
                                            ...
                                            <p class="mt-1 text-xs text-gray-500">
                                                Insufficient Funds. Please transfer more STATE to your wallet before purchasing.
                                            </p>
                                        </div>
                                        <div class="ml-4 flex-shrink-0 flex">
                                            <button onClick={() => setConfirm(false)} className="bg-white rounded-md inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
            ...
            <button onClick={handleSendTransaction} type="button" class="relative flex bg-stateset-yellow border border-transparent rounded-md py-2 px-8 items-center justify-center text-sm font-medium text-gray-900 hover:bg-stateset-dark-yellow">
                Buy Now
            </button>
        </main>
