...
const MsgRepayLoan = new Type("MsgRepayLoan")
...
export default (props) => {
    ...
    const handleOnSubmit = async () => {
        ...
        myRegistry.register("/stateset.core.loan.MsgRepayLoan", MsgRepayLoan);
        ...
        if (client) {
            ...
            const message = {
                typeUrl: "/stateset.core.loan.MsgRepayLoan",
                value: {
            ...
            const response = await client.signAndBroadcast(creator_address, [message], "auto", 'repaying a loan from stateset zone');
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 w-0 flex-1 pt-0.5">
                                            ...
                                            <p class="mt-1 text-xs text-gray-500">
                                                Loan Repayed. Anyone with a link can now view this transaction.
                                            </p>
                                        </div>
