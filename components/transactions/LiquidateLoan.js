...
const MsgCancelLoan = new Type("MsgLiquidateLoan")
...
export default (props) => {
    ...
    const handleOnSubmit = async () => {
        ...
        myRegistry.register("/stateset.core.loan.MsgLiquidateLoan", MsgCancelLoan);
        ...
        if (client) {
            ...
            const message = {
                typeUrl: "/stateset.core.loan.MsgLiquidateLoan",
                value: {
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 w-0 flex-1 pt-0.5">
                                            ...
                                            <p class="mt-1 text-xs text-gray-500">
                                                Loan Liquidated. Anyone with a link can now view this transaction.
                                            </p>
                                        </div>
