...
const MsgFinancePurchaseorder = new Type("MsgFinancePurchaseorder")
...
export default (props) => {
    ...
    const handleOnSubmit = async() => {
        ...
        if (client) {
            ...
            const message = {
                typeUrl: "/stateset.core.purchaseorder.MsgFinancePurchaseorder",
                value: {
            ...
            const response = await client.signAndBroadcast(creator_address, [message], "auto", 'financing a purchaseorder from stateset zone');
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 w-0 flex-1 pt-0.5">
                                            ...
                                            <p class="mt-1 text-xs text-gray-500">
                                                Purchase Order Financed. Anyone with a link can now view this transaction.
                                            </p>
                                        </div>
