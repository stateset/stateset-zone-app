...
export default class ChannelTextbox extends React.Component {
  ...
  generateTranslation = async (client) => {
    ...
    handleDarkMode = async (client, color) => {
        ...
        if (color_ = "light") {
            mode = ` for each <div class="dark"> turn it into <div class="light">`;
        }

        if (color_ = "dark") {
            mode = ` turn <div class="light"> into <div class="dark">`;
        };
        ...
        return (
            ...
            <div class="dark:bg-slate-900">
                <form className="dark:bg-slate-900" onSubmit={sendMessage}>
                    ...
                    <button type="button" type="submit" className="inline-flex items-center px-4 py-2 mt-4 ml-8 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        Send
                    </button>
                    <br />
                </form>
