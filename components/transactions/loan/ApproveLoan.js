...
const MsgApproveLoan = new Type("MsgApproveLoan")
...
export default (props) => {
    ...
    const handleOnSubmit = async () => {
        ...
        if (client) {
            ...
            const message = {
                typeUrl: "/stateset.core.loan.MsgApproveLoan",
                value: {
            ...
            const response = await client.signAndBroadcast(creator_address, [message], "auto", 'approving a loan from stateset zone');
